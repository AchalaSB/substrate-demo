...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("substrate-assignment"),
	impl_name: create_runtime_str!("substrate-assignment"),
	authoring_version: 3,
	spec_version: 4,
	impl_version: 4,
...
/// Used for the module template in `./template.rs`
impl calculator::Trait for Runtime {
	type Event = Event;
}
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		Sudo: sudo,
		// Used for the module template in `./template.rs`
		TemplateModule: calculator::{Module, Call, Storage, Event<T>},
	}
);
